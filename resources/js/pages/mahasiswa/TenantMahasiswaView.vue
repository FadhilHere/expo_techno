...
import { Plus, Package, Pencil, Trash2, X, Mail, Phone } from 'lucide-vue-next';
    ...
    <AuthLayout title="Tenant Mahasiswa" description="Kelola informasi tenant dan produk Anda">
        ...
        <div class="p-6 space-y-6">
            ...
            <div v-if="!hasTenant" class="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h2 class="text-2xl font-bold mb-2">Belum Ada Tenant</h2>
            ...
            <div v-else class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Informasi tenant yang dikelola oleh admin Technologia
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="grid md:grid-cols-4 gap-6">
                        <!-- Logo -->
                        <div class="flex flex-col items-center justify-center">
                            <div class="h-32 w-32 rounded-md overflow-hidden bg-gray-100 border">
                        ...
                        <div class="md:col-span-3 space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1">{{ tenant?.deskripsi || 'Belum ada deskripsi' }}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                        <div class="space-y-4">
                            <div v-if="products && products.length > 0">
                                <!-- Product list -->
                                <div class="rounded-md border p-4 mb-3" v-for="product in products" :key="product.id">
                                    <div class="flex items-start justify-between">
                                        <div class="flex space-x-4">
                                            <div class="h-16 w-16 rounded-md overflow-hidden bg-gray-100">
                                                <img v-if="product.foto_produk_url" :src="product.foto_produk_url" class="h-full w-full object-cover" alt="Product image" />
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-muted-foreground">Rp {{ product.harga.toLocaleString('id-ID') }}</p>
                                                <p v-if="product.deskripsi" class="text-sm text-muted-foreground line-clamp-1">{{ product.deskripsi }}</p>
                                            </div>
                                        </div>
