...
import { Plus, Pencil, Trash2, X, Package } from 'lucide-vue-next'
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-4">
                        <div>
                            ...
                            <Select v-model="formData.tahun_expo_id" required>
                                <SelectTrigger id="tahun-expo-select" class="w-full" :class="{'border-red-500 focus:ring-red-500': validationErrors.tahun_expo_id}">
                            ...
                            <p v-if="validationErrors.tahun_expo_id" class="text-red-500 text-xs mt-1">
                        ...
                        <div>
                            ...
                            <Select v-model="formData.kategori_id" required>
                                <SelectTrigger id="kategori-select" class="w-full" :class="{'border-red-500 focus:ring-red-500': validationErrors.kategori_id}">
                            ...
                            <p v-if="validationErrors.kategori_id" class="text-red-500 text-xs mt-1">
                        ...
                        <div>
                            ...
                            />
                            <p v-if="validationErrors.nama_tenant" class="text-red-500 text-xs mt-1">
                        ...
                        <div>
                            ...
                            />
                            <p v-if="validationErrors.whatsapp_tenant" class="text-red-500 text-xs mt-1">
                        ...
                        <div>
                            ...
                            />
                            <p v-if="validationErrors.logo" class="text-red-500 text-xs mt-1">
